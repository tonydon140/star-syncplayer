...
public class StringMessage extends Message {
    ...
    public static final StringMessage ROOM_CREATED = new StringMessage(ActionCode.ROOM_CREATED, null);
    public static final StringMessage CHAT = new StringMessage(ActionCode.CHAT, null);
