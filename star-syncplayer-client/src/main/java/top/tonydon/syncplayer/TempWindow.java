...
public class TempWindow {
    private final Logger log = LoggerFactory.getLogger(TempWindow.class);
    ...
    public TempWindow(Stage primaryStage) {
    ...
    private void setMenuBar() {
        ...
        createRoomItem.setOnAction(event -> {

        });
        addRoomItem.setOnAction(event -> {
